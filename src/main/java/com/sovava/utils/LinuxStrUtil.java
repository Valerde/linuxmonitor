...
import com.sovava.pojo.DeskState;


import com.sovava.pojo.CpuState;
import com.sovava.pojo.DiskIoState;
import com.sovava.pojo.MemState;
import com.sovava.pojo.NetIoState;
import com.sovava.pojo.SysLoadState;
import com.sovava.pojo.TcpState;
...
public class LinuxStrUtil {
    ...
    public static MemState setViewMem(String memStr) {
        ...
        for (int i = 1; i < 2; i++) {
            ...
            memState.setFree(row.split(StaticKeys.SPLIT_KG)[6]);
        }
        try {
    ...
    public static String getYxDays(String loadStr) {
        ...
        if (match.find()) {
            ...
            int upIndex = loadStr.indexOf("up");
            int dzhcIndex = loadStr.indexOf(",", upIndex);
            days = loadStr.substring(upIndex + 2, dzhcIndex) + "hours";
        }
